...
const UserManager: React.FC = () => {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      >
        <div>
          <h1 className="text-3xl font-bold text-charcoal font-onest">User Management</h1>
          <p className="text-gray-text mt-1">Manage user accounts and monitor activity</p>
        </div>
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center space-x-3">
                        <div className="w-10 h-10 bg-cool-blue rounded-full flex items-center justify-center text-white font-semibold">
                          {user.name
                            .split(" ")
                            .map((n) => n[0])
                            .join("")}
                    ...
                    <td className="px-6 py-4">
                      <div className="space-y-2">
                        ...
                        <div className="text-xs text-gray-text">Last active: {user.lastActive}</div>
                      </div>
                    </td>

                    <td className="px-6 py-4">
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${getSubscriptionColor(user.subscription)}`}
                      >
                        {user.subscription === "free"
                          ? "Free"
                          : user.subscription === "3-day"
                            ? "3-Day"
                            : user.subscription === "4-day"
                              ? "4-Day"
                              : "Premium"}
                      </span>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <div className="space-y-1">
                        <div className="flex items-center text-sm">
                          <Award className="w-3 h-3 mr-1 text-success-green" />
                          <span className="font-medium">{user.averageScore}%</span>
                        </div>
                        <div className="text-xs text-gray-text">{user.quizzesCompleted} quizzes completed</div>
                      </div>
                    </td>
